...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class NewPostController : ControllerBase
    {
        ...
        public NewPostController(ILogger<NewPostController> logger, ICommandDispatcher commandDispatcher = null)
        {
            _logger = logger;
        ...
        public async Task<ActionResult> NewPostAsync([FromBody]NewPostCommand command)
        {
            ...
            try
            {
                var postCommand = new NewPostCommand(id, command.Author, command.Message);
                await _commandDispatcher.SendAsync(postCommand);
